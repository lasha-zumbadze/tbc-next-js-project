...
function Footer() {
  return (
    <footer>
      <Reservation />
      <div className="py-12 px-80 bg-[#232323] grid grid-cols-3 text-white items-center justify-items-center">
        <div>
          <Logo titleFont={5} subtitleFont={2} letterSpace={1} />
          <div className="text-[1.4rem] text-[#b6b6b6] mt-16">
            <p>Copyright &#169; 2024 All rights reserved.</p>
            <p className="mt-4 cursor-pointer w-fit transition-all hover:text-[#c8a97e]">
