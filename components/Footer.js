...
function Footer() {
  return (
    <footer>
      <Reservation />
      <div className="py-24 px-32 lg:py-12 md:px-20 lg:px-28 bg-backgroundDarkblue grid md:grid-cols-2 lg:grid-cols-3 text-white items-center justify-center justify-items-center gap-y-16 md:gap-y-16 lg:gap-x-8">
