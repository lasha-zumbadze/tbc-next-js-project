function Reservation() {
  return (
    <section className="bg-reservation bg-cover bg-center bg-no-repeat h-[50rem] flex flex-col justify-center items-center gap-20">
      <div className="text-center mb-8 leading-tight">
        <h2 className="font-alexBrush text-[#c8a97e] text-7xl font-normal">
          5 Stars
        </h2>
        <h3 className="text-white text-[5rem] font-normal ">
          Make a Reservation
        </h3>
      </div>
      <div className="flex gap-12">
        <input
          type="date"
          className="w-[22rem] h-20 px-8 border-none outline outline-[3px] outline-[#c8a97e] bg-[#c2a49500] text-white text-3xl leading-none font-semibold"
        />
        <select className="w-[22rem] h-20 px-8 border-none outline outline-[3px] outline-[#c8a97e] bg-[#c2a49500] text-white text-3xl leading-none font-semibold">
      ...
      <button className="w-[25rem] border-none bg-[#c8a97e] px-6 py-6 text-white text-[2rem] cursor-pointer transition-all hover:outline hover:outline-[3px] hover:outline-[#c8a97e] hover:bg-[#c2a49500]">
        Make a Reservation
      </button>
    </section>
  );
