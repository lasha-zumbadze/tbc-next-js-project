...
//   return (
//     <div className="pt-40">
//       <div className="flex justify-center mb-16 py-8 items-center gap-16">
//         <Decor />
//         <div className="flex items-center flex-col">
//           <h1 className="font-alexBrush text-7xl md:text-[5rem] text-[#a68250]">
//             KoKeshI
//           </h1>
//           <h2 className="text-7xl md:text-[5rem] -mt-8 italic text-white">
//             {dish.title}
//           </h2>
//         </div>
//         <Decor />
//       </div>
//       <div className="grid md:grid-cols-2 md:py-16 md:pb-40 gap-x-8 gap-y-8 shadow-2xl w-4/5 m-auto">
...
//             ))}
//           </div>
//           <div className="border-solid w-full text-justify mt-10">
...
//         ABOUT OUR MEALS
//       </h2>
//       <div className="border-t-textGolden border-t-2 w-4/5 m-auto text-gray-200 text-[1.6rem] p-8 pb-24">
//         <p>
